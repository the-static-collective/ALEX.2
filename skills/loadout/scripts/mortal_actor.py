"""Bind immutable LOADOUT compiles into one mortal-actor evaluation run."""
...
def bind_mortal_actor_compiles(
    *,
    ...
    if child:
        if (
            evaluation_compile["effect_fence_ref"] != entry_compile["effect_fence_ref"]
            or evaluation_compile["effective_effects"] != entry_compile["effective_effects"]
        ):
